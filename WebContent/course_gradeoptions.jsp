...
<title>Course Grade Options</title>
</head>
        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "INSERT INTO CourseGradeOption VALUES (?, ?)");
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE CourseGradeOption SET OPTION = ? WHERE COURSETITLE = ?");
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "DELETE FROM CourseGradeOption WHERE COURSETITLE = ? AND OPTION = ?");
            ...
            <!-- Add an HTML table header row to format the results -->
                <table border="1">
                    ...
                    <tr>
                        <form action="course_gradeoptions.jsp" method="get">
                            <input type="hidden" value="insert" name="action">
                            <th><input value="" name="COURSETITLE" size="20"></th>
                            <th><input value="" name="OPTION" size="20"></th>
            ...
            %>
                    ...
                    <tr>
                        <form action="course_gradeoptions.jsp" method="get">
                            ...
                            <%-- Get the SSN, which is a number --%>
                            <td>
                                <input value="<%= rs.getString("OPTION") %>" 
                                    name="OPTION" size="20">
                            </td>
                        ...
                        <form action="course_gradeoptions.jsp" method="get">
                            ...
                            <input type="hidden" 
                                value="<%= rs.getString("OPTION") %>" name="OPTION">
                            <%-- Button --%>
                            <td>
