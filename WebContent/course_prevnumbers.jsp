        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "INSERT INTO CoursePrevNumber VALUES (?, ?)");
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE CoursePrevNumber SET PREVNUMBER = ? WHERE COURSETITLE = ?");
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "DELETE FROM CoursePrevNumber WHERE COURSETITLE = ? AND PREVNUMBER = ?");
            ...
            %>
                    ...
                    <tr>
                        ...
                        <form action="course_prevnumbers.jsp" method="get">
                            ...
                            <input type="hidden" 
                                value="<%= rs.getString("PREVNUMBER") %>" name="PREVNUMBER">
                            <%-- Button --%>
                            <td>
