...
<title>Course Previous Numbers</title>
</head>
        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "INSERT INTO CourseUnitOption VALUES (?, ?)");
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE CourseUnitOption SET UNITS = ? WHERE COURSETITLE = ?");
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "DELETE FROM CourseUnitOption WHERE COURSETITLE = ? AND UNITS = ?");
            ...
            <!-- Add an HTML table header row to format the results -->
                <table border="1">
                    ...
                    <tr>
                        <form action="course_unitoptions.jsp" method="get">
            ...
            %>
                    ...
                    <tr>
                        ...
                        <form action="course_unitoptions.jsp" method="get">
                            ...
                            <input type="hidden" 
                                value="<%= rs.getString("UNITS") %>" name="UNITS">
                            <%-- Button --%>
                            <td>
